...
I wrote a data\_sync.c that copies the contents of source.txt into backup.txt to simulate file synchronization.
...
*gcc data\_sync.c \-o data\_sync*

To inspect the ELF binary, run:

*objdump \-x data\_sync*
